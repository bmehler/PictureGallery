...
define( 'WORKING_DIRECTORY', ROOT_PATH.'/applications/ListView');
...
/* Includiert das Respository */
require_once(__DIR__ .'/src/Repository/UploadRepository.inc.php');

/* Includiert das Respository */
require_once(__DIR__ .'/src/Repository/ListViewRepository.inc.php');
